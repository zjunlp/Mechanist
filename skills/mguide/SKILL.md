...
|---|---|
| **Start now, run it through unattended** — *recommended*. "It'll run start to finish on its own and come back to you with the results; you don't have to sit here." | **You invoke** `/auto — behavior-source: <X>, mechanism: <Y>`. |
